...
fn test_op_log() {
    ...
    │     - qpvuntsm/1 e8849ae1 (empty) (no description set)
    │
    ...
    │     [38;5;1m-[39m [1m[39mq[0m[38;5;8mpvuntsm[1m[39m/1[0m [1m[38;5;4me[0m[38;5;8m8849ae1[39m [38;5;2m(empty)[39m [38;5;2m(no description set)[39m
    │
...
fn test_op_diff() {
    ...
    Changed commits:
    ○  - rnnslrkn/0 4ff62539 Commit 2
    ○  - rnnkyono/0 11671e4c Commit 3
    ○  - pukowqtp/0 0cb7e07e Commit 1
    ○  - qpvuntsm/0 e8849ae1 (empty) (no description set)
    ...
    bookmark-1@origin:
    + untracked (absent)
    - tracked pukowqtp/0 0cb7e07e Commit 1
    bookmark-2@origin:
    + untracked (absent)
    - untracked rnnslrkn/0 4ff62539 Commit 2
    bookmark-3@origin:
    + untracked (absent)
    - untracked rnnkyono/0 11671e4c Commit 3
    [EOF]
    ");
...
fn test_op_diff_patch() {
    ...
    ○  + qpvuntsm 7aa2ec5d (no description set)
       - qpvuntsm/1 6b57e33c (no description set)
       - rlvkpnrz/0 05a2969e (no description set)
       diff --git a/file b/file
    ...
    ○  - mzvwutvl/0 6cbd01ae (empty) (no description set)
...
fn test_op_diff_sibling() {
    ...
    Changed commits:
    ○    - mzvwutvl/0 08c63613 (empty) A
    ├─╮
    │ ○  - kkmpptxz/0 6c70a4f7 A.1
    │    A file1
    ○  - zsuskuln/0 47b9525e A.2
       A file2
...
fn test_op_diff_divergent_change() {
    ...
    │  2b
    │ ○  rlvkpnrz/1 test.user@example.com 2001-02-03 08:05:09 f189cafa divergent
    ├─╯  2a
    ...
    ○  + rlvkpnrz/0 c5cad9ab 2b
       - rlvkpnrz/4 4f7a567a (empty) (no description set)
    ○  + rlvkpnrz/1 f189cafa 2a
       - rlvkpnrz/4 4f7a567a (empty) (no description set)
...
fn test_op_diff_at_merge_op_with_rebased_commits() {
    ...
    insta::assert_snapshot!(work_dir.run_jj(["log"]), @r"
    @  rlvkpnrz/1 test.user@example.com 2001-02-03 08:05:09 7ed5a610 divergent
    │  (empty) 2a
...
fn test_op_show_patch() {
    ...
    │     - rlvkpnrz/1 c1c924b8 (empty) (no description set)
    │     diff --git a/file b/file
    │     index 7898192261..6178079822 100644
    │     --- a/file
    │     +++ b/file
...
fn test_op_show_template() {
    ...
    ○  + qpvuntsm b52b7cb5 first commit
       - qpvuntsm/1 0883ea50 (no description set)
